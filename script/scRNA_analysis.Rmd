...
# aims
   - sc scale and normalization
   - sc integration: 
      all sc integration; 
      pure B cell integration(used for down stream DEGs analysis)
 
# comments: 
  - this integrated data is used for downstream integration based analysis: no2, no5, no6
...
library(tidyverse)
library(cowplot)
source("/home/hohu/Desktop/LinSeq/script/linkseqFunctions.R")
...
```{r}
##==============================================================================================####
# singR prediction and bcr integration to meta
# only predict the label.main , because label.fine already exist in sc from xiaoli
 
outputPlot<- "/home/hohu/Desktop/LinSeq/result/plot/scPreprocessNo2/"
ifelse(!dir.exists(outputPlot),dir.create(outputPlot, recursive = T),FALSE)

outputSummary<- "/home/hohu/Desktop/LinSeq/result/summary/scPreprocessNo2/"
ifelse(!dir.exists(outputSummary),dir.create(outputSummary, recursive = T),FALSE)

bcrInputPath<-"/home/hohu/Desktop/LinSeq/data/bcr_lv1/"
rdsInputPath<- "/home/hohu/Desktop/LinSeq/data/sc/"
...
# B cell associated immune cells
