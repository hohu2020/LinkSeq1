...
output_path <- "/home/hohu/Desktop/LinSeq/result/plot/no6/fig5cd/"
ifelse(!dir.exists(output_path), dir.create(output_path, recursive = T),FALSE)

output_summary<-"/home/hohu/Desktop/LinSeq/result/summary/no6/fig5cd/"
...
summary_scBcr <- heatmap_VJH(df_fileList=fileList,df_bcrInputPath=file_pathBcr,
...
summary_scBcr <- heatmap_VJH(df_fileList=fileList,df_bcrInputPath=file_pathBcr,
                                      rdsInputPath=file_pathGex,outputPlot = ouput_path,
